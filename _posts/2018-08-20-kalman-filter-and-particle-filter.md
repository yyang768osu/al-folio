...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="images/kalman_filter/bivariant_normal.png" class="img-fluid rounded z-depth-1" zoomable=false %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="images/kalman_filter/linear_dynamic_system.png" class="img-fluid rounded z-depth-1" zoomable=false %}
    </div>
</div>
